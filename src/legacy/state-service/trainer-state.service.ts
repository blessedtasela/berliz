...
// import {
//   Trainers, TrainerLikes, TrainerPricing, TrainerIntroduction,
//   TrainerBenefits, TrainerFeatureVideo, TrainerPhotoAlbum, TrainerVideoAlbum,
//   TrainerClients, TrainerSubscription, TrainerReview, TrainerTestimonials
...
//   private TrainerReviewLikessSubject = new BehaviorSubject<TrainerReview | null>(null);
//   TrainerReviewLikessData$: Observable<TrainerReview | null> = this.TrainerReviewLikessSubject.asObservable();
...
//   setTrainerReviewLikessSubject(data: TrainerReview): void { this.TrainerReviewLikessSubject.next(data); }
