...
// import { Priority, TodoList } from '../../app/models/todoList.interface';
// import { SnackBarService } from '../../app/services/snack-bar.service';
// import { FilterState, SearchSortOption } from '../../app/models/FilterState.interface';
...
//   // NOTE: this method had a bug — t.user.firstName/lastName — TodoList has no
//   // `user` field, only flat userFirstname/userLastname. It only compiled because
//   // of `any` typing through the BehaviorSubject chain. Fixed version now lives at
//   // src/app/state/todo/todo.utils.ts (filterTodos).
