...
// import { CenterLikes, CenterPricing, Centers } from '../../app/models/centers.interface';
...
//   public likeCentersData$: Observable<CenterLikes[]> = this.likeCentersSubject.asObservable();
...
//   setLikeCentersSubject(data: CenterLikes[]) {
...
//   getCenterLikes(): Observable<CenterLikes[]> {
...
//     return this.centerService.getAllPricing().pipe(
//       tap((response: any) => {
