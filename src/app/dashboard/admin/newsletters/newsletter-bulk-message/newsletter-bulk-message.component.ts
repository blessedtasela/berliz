...
@Component({
  selector: 'app-newsletter-bulk-message',
  templateUrl: './newsletter-bulk-message.component.html',
  styleUrls: ['./newsletter-bulk-message.component.css']
})
export class NewsletterBulkMessageComponent {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<NewsletterBulkMessageComponent>) {
  }
