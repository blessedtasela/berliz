    ...
    children: [
      ...
      // ── HUB ──────────────────────────────────────────
      {
        ...
        children: [
          ...
          { path: 'feedback', loadChildren: () => import('../admin/berliz-feedback/berliz-feedback.module').then(m => m.BerlizFeedbackModule), canActivate: [AuthGuard, RoleGuard], data: { breadcrumb: 'Feedback', expectedRole: ['admin'] } },
          ...
          { path: 'feedback', loadChildren: () => import('../admin/berliz-feedback/berliz-feedback.module').then(m => m.BerlizFeedbackModule), canActivate: [AuthGuard], data: { breadcrumb: 'Feedback', expectedRole: ['admin'] } },
