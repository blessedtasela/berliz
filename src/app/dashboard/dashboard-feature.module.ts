...
const dashboardRoutes: Routes = [
  {
    ...
    children: [
      ...
      // Partnership
      {
        ...
        children: [
          { path: '', component: PartnerComponent, canActivate: [AuthGuard], data: { breadcrumb: null, expectedRole: expectedRoleAll } },
          { path: 'trainer-details', component: MyTrainerMainComponent, canActivate: [AuthGuard], data: { breadcrumb: 'Trainer Details', expectedRole: expectedRoleAll } }
        ]
      },
      ...
      // ── HUB ──────────────────────────────────────────
      {
        ...
        children: [
          { path: '', component: HubMainComponent, canActivate: [AuthGuard], data: { breadcrumb: null, expectedRole: expectedRoleAll } },
