...
export class TrainerStateServiceService {
  private activeTrainersSubject = new BehaviorSubject<Trainers[]>([]);
  public activeTrainersData$: Observable<any> = this.activeTrainersSubject.asObservable();
  private allTrainersSubject = new BehaviorSubject<Trainers[]>([]);
  public allTrainersData$: Observable<any> = this.activeTrainersSubject.asObservable();
